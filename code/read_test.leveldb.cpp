...
int main(){
  //db初始化
    ...
    cout << "负载准备时间：............." << endl;
    cout <<"平均生成时间："<<atime/READ_SIZE <<"ns, QPS："<<1000000000LL*READ_SIZE/atime<<", 换算为128BKV的吞吐率为"<< 1000000000LL*128/1024/1024*READ_SIZE/atime <<"MB/s" <<endl;
    cout <<"两线程竞争测试:............"<<endl;
    cout <<"平均完成时间："<<btime/READ_SIZE <<"ns, QPS："<<1000000000LL*READ_SIZE/btime<<", 换算为128BKV的吞吐率为"<< 1000000000LL*128/1024/1024*READ_SIZE/btime <<"MB/s" <<endl;
    return 0;
}