...
// std::string redirect_dir="/mnt/tmp/";
...
// }
// std::string redirect_file_name(const std::string& long_file_name){
//   std::string filename=get_file_name(long_file_name);
//   return redirect_dir+filename; 
// }
