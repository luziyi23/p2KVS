...
colors = ["green", "#ffb548", "red", "#a6092e", "#ffea67", "#ffb548", "red", "#a6092e"]
excel = xlrd.open_workbook("exp-read-batch.xlsx")
...
plt.legend(ncol=1, fontsize=12, borderpad=False, framealpha=1, labelspacing=0.1, columnspacing=0.5)
leg = plt.gca().get_legend()
ltext = leg.get_texts()
plt.setp(ltext, fontsize=12, fontweight='bold')  # 设置图例字体的大小和粗细
# ax_sub = gca.twinx()
# ax_sub.set_ylabel('KQPS',fontsize=12,fontweight='bold')
# ax_sub.set_ylim(0,3000)
# plt.yticks(fontsize=12)
fig.tight_layout()
plt.savefig('./exp-read-batch.pdf', format='pdf')
plt.show()
