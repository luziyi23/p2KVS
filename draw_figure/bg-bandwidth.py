...
plt.hlines(2200, 0, 100, linestyles='--', colors="black", label="SSD max bandwidth", linewidth=2)
...
plt.yticks(fontsize=14)
# plt.legend()          #显示各曲线的图例
ax.legend(loc=4, numpoints=1, ncol=1, fontsize=14, borderpad=False, framealpha=1, bbox_to_anchor=(1, 0.4))
leg = ax.get_legend()
ltext = leg.get_texts()
