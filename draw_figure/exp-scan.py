...
excel = xlrd.open_workbook("exp-scan.xlsx")
...
print(xs)
print(ys)
labelx = list(sheet.col_values(0)[1:])
...
plt.legend(ncol=1, fontsize=12, borderpad=False, framealpha=1, labelspacing=0.1, columnspacing=0.1)
leg = plt.gca().get_legend()
ltext = leg.get_texts()
plt.setp(ltext, fontsize=12, fontweight='bold')  # 设置图例字体的大小和粗细
fig.tight_layout()
plt.savefig('./exp-scan.pdf', format='pdf')
plt.show()
